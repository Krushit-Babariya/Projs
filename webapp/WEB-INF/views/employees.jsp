...
<div class="modal fade" id="uploadBox" tabindex="-1" aria-labelledby="uploadBoxModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="upload" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title" id="uploadBoxModalLabel">Upload Excel</h5>
