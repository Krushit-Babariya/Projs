...
public class EmployeeServiceImpl implements IEmployeeService {
    ...
    @Override
    public List<Employees> getAllEmployees() throws ApplicationException {
        return employeeRepository.findAll();
    }

    @Override
    public List<Employees> getEmployeesPagedSorted(int page, int size, String sortBy, String sortDir) throws ApplicationException {
        return employeeRepository.findAllPagedSorted(page, size, sortBy, sortDir);
    }

    @Override
    public void updateEmployee(Employees emp) throws ApplicationException {
        employeeRepository.updateEmployee(emp);
    }

    @Override
    public void deleteEmployee(int employeeId) throws ApplicationException {
        if (employeeRepository.isAnyEmployeeAssociated(employeeId)) {
            throw new ApplicationException(Message.User.USER_CANNOT_DELETE);
        }
        employeeRepository.deleteEmployee(employeeId);
    }

    @Override
    public List<Employees> getManagersByDepartmentId(int departmentId) throws ApplicationException {
        return employeeRepository.getManagersByDepartmentId(departmentId);
    }

    @Override
    public void addEmployee(Employees emp) throws ApplicationException {
        employeeRepository.addEmployee(emp);
    }

    @Override
    public Employees getEmployeeById(int id) throws ApplicationException {
