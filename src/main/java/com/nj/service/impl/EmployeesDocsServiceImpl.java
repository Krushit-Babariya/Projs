...
public class EmployeesDocsServiceImpl implements IEmployeesDocsService {
    ...
    @Override
    public void saveEmployeeDocs(EmployeeDocsDTO dto) throws ApplicationException {
        try {
...
//        return uniqueName;
    ...
    @Override
    public void deleteEmployeeDocs(int id) throws ApplicationException {
        repository.deleteEmployeeDocs(id);
    }

    @Override
    public List<EmployeeDocs> getDocsByEmployeeId(int employeeId) throws ApplicationException {
        return repository.getEmployeeDocsByEmployeeId(employeeId);
    }

    @Override
    public EmployeeDocs getDocById(int id) throws ApplicationException {
        return repository.getEmployeeDocsById(id);
    }

    @Override
    public String fetchResumePathByJsId(int id) throws ApplicationException {
        return DIR + repository.getResumePathByEmployeeId(id);
    }

    @Override
    public String fetchPhotoPathByJsId(int id) throws ApplicationException {
